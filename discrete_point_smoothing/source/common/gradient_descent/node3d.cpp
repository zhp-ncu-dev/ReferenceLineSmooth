...
// possible movements
//const double Node3D::dy[] = { 0,        -0.032869,  0.032869};
//const double Node3D::dx[] = { 0.62832,   0.62717,   0.62717};
//const double Node3D::dt[] = { 0,         0.10472,   -0.10472};

// R = 6, 6.75 DEG
const double Node3D::dy[] = { 0,        -0.0415893,  0.0415893};
const double Node3D::dx[] = { 0.7068582,   0.705224,   0.705224};
const double Node3D::dt[] = { 0,         0.1178097,   -0.1178097};

// R = 3, 6.75 DEG
//const double Node3D::dy[] = { 0,        -0.0207946, 0.0207946};
//const double Node3D::dx[] = { 0.35342917352,   0.352612,  0.352612};
//const double Node3D::dt[] = { 0,         0.11780972451,   -0.11780972451};

//const double Node3D::dy[] = { 0,       -0.16578, 0.16578};
//const double Node3D::dx[] = { 1.41372, 1.40067, 1.40067};
//const double Node3D::dt[] = { 0,       0.2356194,   -0.2356194};
...
bool Node3D::isInRange(const Node3D& goal) const {
    ...
    double dx = std::abs(x - goal.x) / random;
    double dy = std::abs(y - goal.y) / random;
