...
#ifndef PLANNING_BOX2D_H
#define PLANNING_BOX2D_H
...
#include "aabox2d.h"
#include "common/line/line_segment2d.h"
 ...
 */
    ...
    public:
        ...
        /**
         * @brief Constructor which takes box corners
         * @param corners box corner coodinates
         */
        Box2d(const std::vector<math::Vec2d> &corners);
...
//        Box2d(const ObjectInformation objectInformation);
        ...
        /**
         * @brief Gets the smallest axes-aligned box containing the current one at relative coordinate
         * @return An axes-aligned box
         */
        AABox2d GetAABox(const had_map::MapPoint &relativePoint) const;
        ...
        Box2d transFormCoodinate(const had_map::MapPoint &point) const;
