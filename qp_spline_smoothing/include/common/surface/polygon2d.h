...
#ifndef PLANNING_POLYGON2D_H
#define PLANNING_POLYGON2D_H
 ...
 */
    ...
    public:
         ...
         *         polygon or not.
         */
        bool HasOverlap(const LineSegment2d &line_segment, bool judgePointInFlag = true) const;

        /**
        * @brief judge a line segment overlap this polygon or not.
        * @return If the target line segment has overlap with this polygon.
        */
        bool GetOverlap2(const LineSegment2d &line_segment, bool judgePointInFlag = true) const;
