...
PiecewiseJerkSmoothProblem::PiecewiseJerkSmoothProblem(
        const size_t num_of_knots, const double delta_s,
        const std::array<double, 3>& x_init)
        : PiecewiseJerkProblem(num_of_knots, delta_s, x_init) {}

void PiecewiseJerkSmoothProblem::CalculateKernel(std::vector<c_float>* P_data,
...
void PiecewiseJerkSmoothProblem::CalculateOffset(std::vector<c_float>* q) {
